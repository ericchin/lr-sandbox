...
/**
 * Provides the local service interface for BrowserSubscription. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see BrowserSubscriptionLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface BrowserSubscriptionLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.ericwchin.liferay.pwa.service.impl.BrowserSubscriptionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the browser subscription local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link BrowserSubscriptionLocalServiceUtil} if injection and service tracking are not available.
	 */
